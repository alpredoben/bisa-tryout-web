...
import type { I_StageTryoutDropdownProps } from "../../interfaces/tryoutInterface";
import { useEffect, useState } from "react";
import { useFetchDataQuery } from "../../services/tryoutStageApi";

export const StageDropdown: React.FC<I_StageTryoutDropdownProps> = ({
  value,
  onChange,
}) => {
