...
} from "../../services/tryoutStageApi";

export function TryoutStageModal({
  isOpen,
  closeModal,
  isEditMode = false,
  selectedId = null,
  ...
  const eventSubmitHandler = async (e: any) => {
    ...
    try {
      ...
      console.log("Error submit jenis tes", error);
      if(error.status === 422) {
      ...
      <div className="flex flex-col px-2 overflow-y-auto custom-scrollbar">
        <div>
          <h5 className="font-semibold text-gray-800 modal-title text-theme-xl dark:text-white/90 lg:text-2xl mb-4">
            {isEditMode ? "Ubah Jenis Tes" : "Tambah Jenis Tes"}
          </h5>
        </div>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-[auto,1fr] gap-4 mb-4">
            ...
            <input
              ...
              placeholder="Masukkan Nama Jenis Tes...."
            />
          </div>
