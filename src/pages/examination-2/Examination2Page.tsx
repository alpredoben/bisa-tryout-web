            ...
            <div className="w-full border-t border-gray-200 mt-3 py-3">
              ...
              <div className="mt-4 flex flex-col md:flex-row justify-between">
                ...
                <div className="mt-4 flex flex-col md:flex-row space-y-2 md:space-y-0 space-x-0 md:space-x-2">
                  <button
                    type="button"
                    className="w-full md:w-fit rounded-lg bg-yellow-500 p-2.5 md:py-3 md:px-3 text-sm md:text-base font-medium text-white hover:bg-yellow-600"
                  >
                    Lanjutkan ke materi Kecermatans
                  </button>
                </div>
              </div>
            </div>
...
export default Examination2Page;
